...
AddFunctionAutocompletions::usage="Adds autocompletion data to a pattern";
...
GenerateFunctionInfo::usage="Extracts function information";
...
AddFunctionAutocompletions[l_Symbol, v_, head_:Identity]:=
  AddFunctionAutocompletions[
    {
      Block[{$ContextPath={"System`"}}, ToString[Unevaluated@l]],
      SymbolName[Unevaluated@l]//Evaluate
      }, 
    {v, v}, 
    head
    ];
AddFunctionAutocompletions[{l__Symbol}, v_, head_:Identity]:=
  AddFunctionAutocompletions[
    Join[
      ...
      List@@
        Function[Null,
          Block[{$ContextPath={"System`"}}, ToString[Unevaluated@#]], 
          HoldFirst
          ]/@Hold[l]
      ]//Evaluate, 
    Join[v, v], 
